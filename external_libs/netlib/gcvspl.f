...
C
   20 PRINT 700
  700 FORMAT(/'$M(2=cubic), MODE(2=GCV), VAL , N(<=50) = ')
...
C
  ...
  740 FORMAT('0  i         x(i)         y(i)     ',
   ...
   30    CONTINUE
         PRINT 750, I, X(I), Y(I), (Q(IDER), IDER=0,IDM)
